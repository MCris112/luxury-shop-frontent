        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
          <div className="md:col-span-4">
            <h2 className="font-serif text-4xl mb-8 tracking-tight">
              Sign up for <br />
              <span className="italic text-accent">Editorial Updates</span>
            </h2>
          ...
          <div className="md:col-start-7 md:col-span-2">
            <h3 className="text-[10px] uppercase tracking-[0.3em] font-medium text-background/40 mb-8">Navigation</h3>
